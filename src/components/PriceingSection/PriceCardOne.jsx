...
function PriceCardOne() {
  return (
    <div className="relative flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
      <h3 className="mb-4 text-3xl font-bold">Silver Plan</h3>
      ...
      <ul role="list" className="mb-8 space-y-4 text-left">
        ...
        <li className="flex items-center space-x-3">
          ...
          <span className="font-semibold text-[#40739e]">Analytics report</span>
        </li>
        <li className="flex items-center space-x-3">
          {/* <!-- Icon --> */}
          <svg
        ...
        <li className="flex items-center space-x-3">
          ...
          <span className="font-semibold text-[#40739e]">SEO consulting</span>
        </li>
        <li className="flex items-center space-x-3">
          {/* <!-- Icon --> */}
          <svg
        ...
        <li className="flex items-center space-x-3">
          ...
          <span className="font-semibold text-[#40739e]">Ads on service</span>
        </li>
        <li className="flex items-center space-x-3">
          {/* <!-- Icon --> */}
          <svg
